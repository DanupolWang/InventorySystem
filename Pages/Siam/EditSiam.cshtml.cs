...
namespace InventorySystem.Pages.Siam
{
    public class EditSiamModel : PageModel
    {
        ...
        public void OnGet()
        {
            ...
            try
            {
                String connectionString = "Server=tcp:inventory1234567.database.windows.net,1433;Initial Catalog=inventory;Persist Security Info=False;User ID=danupol;Password=Pol13012547;MultipleActiveResultSets=False;Encrypt=True;TrustServerCertificate=False;Connection Timeout=30;";
